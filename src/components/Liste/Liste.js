...
const lagNyRad = (listeId, liste, tekst = '', edit = false) => {
    const dokFraEksisterendeListe = liste.docs
        .find(dok => {
        ...
        <ListItem dense>
            ...
            {data.edit ?
                ...
                <>
                    ...
                    <IconButton aria-label="Endre tekst"
                                size="medium"
                                color="primary"
                    ...
                    {adminmodus &&
                    <IconButton aria-label="Slett rad"
                                size="medium"
                                color="primary"
        ...
        <>
            ...
            >
                ...
                <MenuItem onClick={() => {
                    ...
                    {adminmodus && <ListItemIcon><Done/></ListItemIcon>}
